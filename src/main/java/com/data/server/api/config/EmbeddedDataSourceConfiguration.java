package com.data.server.api.config;
...
//com.db.dataplatform.techtest
@Configuration
@EnableJpaRepositories("com.data.server.api")
public class EmbeddedDataSourceConfiguration {

    public static final String DATA_SOURCE = "dataSource";
    public static final String CLASSPATH_DB_MIGRATION_SETUP_SQL = "classpath:db.migration/setup.sql";
    public static final String PACKAGE_MODEL = "com.data.server.api.persistence.model";
